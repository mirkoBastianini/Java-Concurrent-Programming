...
public class HWJ1 {
    ...
    public static void measureHWJ1(BinaryTreeImplementation tree1k, BinaryTreeImplementation tree100k) {
        ...
        hwj1.BinaryTreeAdderImplementation bta = new hwj1.BinaryTreeAdderImplementation(); //cosi cambio l'implementazione per ogni Homework
        ...
        bt = tree100k;
        bta = new hwj1.BinaryTreeAdderImplementation();
        ...
        System.out.println("End.");
        System.out.println("--------------------------------------------------------------");
         System.out.println("FINE TEST HWJ1");
    }

    public static void warmUp() throws InterruptedException {
        System.out.println("--------------------------------------------------------------");
        System.out.println("INIZIO TEST HWJ1");
